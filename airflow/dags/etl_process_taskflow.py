...
from etl_helpers.minio_utils import (
    ...
    download_to_dataframe, upload_from_dataframe
)
...
def process_etl_taskflow():
    ...
    def download_data(**context):
        ...
        existing_merged = list_objects(BUCKET_NAME, prefix=f"{PREFIX_RAW_MERGED}crimes_12m_")
    ...
    def enrich_data(merge_result, download_result, **context):
        ...
        stations_df = download_to_dataframe(BUCKET_NAME, download_result['stations_file'])
